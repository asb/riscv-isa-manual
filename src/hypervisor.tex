...
The UEIP, UTIP, and USIP fields of {\tt bsip} share the storage with those fields in {\tt sip}---writing them through {\tt bsip} is equivalent to writing them through {\tt sip}.
...
The UEIE, UTIE, and USIE fields of {\tt bsie} share the storage with those fields in {\tt sie}---writing them through {\tt bsie} is equivalent to writing them through {\tt sie}.
