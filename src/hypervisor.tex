...
M-mode or in H-mode when {\tt mstatus}.TSR=0.  HRET sets {\tt hstatus}.SPV=1,
...
hstatus}.SPV are set according to Table~\ref{h-spp}.
...
\end{tabular}
\end{center}
\caption{Value of {\tt sstatus} field SPP and {\tt hstatus} field SPV after a trap into H-mode.}
\label{h-spp}
\end{table*}
